...
is often used to keep the simulation in a desired range of behaviour when maximum fecundity 
is changed. We will set the contact rate depending on this parameter and the maximum fecundity.
Appropriate values of this parameter will depend on the value of the cercariae and miracidia
survival. (Float)
...
will be ~1/100 as the usual sample size is 10mL and a daily amount of urine is ~1L 
(Float >0 & <1)
